  ...
  return (
    <div className="fixed inset-0 z-40 flex">
      ...
      <aside
        ...
        className="animate-in-fade relative z-50 flex h-full w-full max-w-md flex-col border-r border-border bg-card shadow-xl"
      >
        <div className="flex shrink-0 items-center justify-between border-b border-border px-4 py-3">
          <h2 id="filter-drawer-title" className="text-ui font-semibold text-foreground">
            {title}
          </h2>
          <button
            type="button"
